...
def iterative_inference(puzzle_string, model, device, k=5):
    tokens = [10 if c in '0.' else int(c) for c in puzzle_string]
...
# ── One-shot ───────────────────────────────────────────────────────────────────
print("\n=== Masked Diffusion — Hard Puzzles (one-shot, k=81) ===")
evaluate(sample_puzzles, sample_solutions, sample_ratings, model, device, mode='oneshot')

# ── Iterative k=5 ─────────────────────────────────────────────────────────────
print("\n=== Masked Diffusion — Hard Puzzles (iterative, k=5) ===")
start = time.time()
evaluate(sample_puzzles, sample_solutions, sample_ratings, model, device, mode='iterative', k=5)
